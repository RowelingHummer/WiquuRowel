...
<html>
    ...
    <style>
        ...
        .bgimg {
            background-image: url('<?php echo $urlImagen;?>fondo.jpg');
            min-height: 100%;
        ...
        <header class="bgimg rowel-display-container " id="home">
            <div class="rowel-display-middle rowel-wiquu-am  rowel-center" style="padding:48px">
                <form action="/action_page.php" class="rowel-margin">
                    <span class="rowel-jumbo rowel-hide-small rowel-text-wiquu-az"><img class="logo-wiquu" src="<?php echo $urlImagen;?>wiqüu.png" alt="Avatar"></span><br>
                    <span class="rowel-xxlarge rowel-hide-large rowel-hide-medium"><img class="logo-wiquu" src="<?php echo $urlImagen;?>wiqüu.png" alt="Avatar"></span><br>
